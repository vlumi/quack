...
echo "Building Quack-iOS..."
xcodebuild -project Quack.xcodeproj -scheme Quack-iOS \
...
app="$derived/Build/Products/Debug-iphonesimulator/Quack Express.app"
