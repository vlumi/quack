...
public struct Tuning: Equatable, Sendable {
    ...
    public var fieldLength: Double = Run.fieldLength
...
public struct TuningDial: Identifiable {
    ...
    public static let all: [TuningDial] = [
        ...
        TuningDial(
            id: "hazards.engageRange", section: .hazards, keyPath: \.rival.engageRange,
            range: 50...800, step: 10, decimals: 0),
        TuningDial(
            id: "hazards.fireRange", section: .hazards, keyPath: \.rival.fireRange,
            range: 20...300, step: 10, decimals: 0),
        TuningDial(
            id: "hazards.burst", section: .hazards, keyPath: \.rival.burst, range: 0.1...2,
            step: 0.05, decimals: 2),
        TuningDial(
            id: "hazards.pause", section: .hazards, keyPath: \.rival.pause, range: 0.2...5,
            step: 0.1, decimals: 1),
        TuningDial(
