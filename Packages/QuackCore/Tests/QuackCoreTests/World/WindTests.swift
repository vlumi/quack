...
final class WindTests: AirfieldTestCase {
    ...
    func testCloudsDriftAtTheWindAndBalloonsAtAShare() throws {
        ...
        XCTAssertEqual(Run(seed: 2).clouds, Run(seed: 2).clouds)
        XCTAssertNotEqual(Run(seed: 2).clouds, Run(seed: 3).clouds)
        for c in Run(seed: 2).clouds {
